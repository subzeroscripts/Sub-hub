...
local Window = OrionLib:MakeWindow({Name = "Sub Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Sub Hub"})

OrionLib:MakeNotification({
	Name = "Sub Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://2140212606",
	Time = 7
})
